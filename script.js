...
document.querySelector('.contact-form').addEventListener('submit', function(e) {
    e.preventDefault();
    alert('Terima kasih! Pesanan Anda telah dikirim. Kami akan hubungi via WhatsApp dalam 24 jam.');
    this.reset();
});
...
// Observe elements
document.querySelectorAll('.service-card, .step, .contact-form').forEach(el => {
    el.style.opacity = '0';
